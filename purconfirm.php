<?php 
    ...
    if(isset($_POST['confirm-btn'])){
        ...
        if($conn){
			...
			$city=$_POST['city'];
			$zip=$_POST['zip'];
            $sql = "INSERT INTO `payments`( `purid`, `nameOnCard`, `cardNumber`, `expiryDate`, `expiryYear`, `cvv`, `address`, `city`, `zip`) VALUES ( '$purid', '$nameOnCard', '$cardNumber', '$expiryDate', '$expiryYear', '$cvv', '$address', '$city', '$zip')";
...
<head>
    ...
    <title>Purchase confirm Form</title>
    <style>
    body {
        font-family: Arial;
        font-size: 17px;
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input type="text" id="fname" name="firstname"
                                value="<?php echo $_SESSION['purch']['firstname']." ".$_SESSION['purch']['lastname']; ?>"
                                readonly>
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="email" value="<?php echo $_SESSION['purch']['email']; ?>"
                                readonly>
                            ...
                            <div class="row">
                                <div class="col-50">
                                    ...
                                    <input type="text" id="state" name="state" value="<?php echo$_SESSION['purch']['state']; ?>" readonly />
                                </div>
                                <div class="col-50">
							...
							<input type="text" id="amt" name="amount" value="<?php echo $_SESSION['purch']['amount']; ?>" readonly>
                        </div>
